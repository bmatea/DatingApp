...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public MessageHub(IMessageRepository messageRespository, IMapper mapper, IUserRepository userRepository, IMessageRepository messageRepository, IHubContext<PresenceHub> presenceHub, PresenceTracker tracker)
        {
            _tracker = tracker;
        ...
        {
            var group = await RemoveFromMesageGroup();
        ...
        private async Task<Group> RemoveFromMesageGroup()
        {
